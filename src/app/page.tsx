        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              ...
              <Link href="/blog" className="px-3 py-2 text-gray-600 hover:text-[#1c4953] font-medium transition-colors text-sm">
                Blog
              </Link>
          ...
          {mobileMenuOpen && (
            <nav className="lg:hidden pb-4 space-y-2 border-t border-gray-100 pt-4">
              ...
              <Link href="/blog" className="block py-2 text-gray-600 hover:text-[#1c4953] font-medium">
                Blog
              </Link>
